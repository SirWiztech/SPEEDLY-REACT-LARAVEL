...
export default function DriverProfileMobile() {
            ...
            html: `
                <div style="padding: 0 4px;">
                    <div style="background: linear-gradient(135deg, #ff5e00, #ff8c38); border-radius: 16px; padding: 20px; margin-bottom: 20px; color: white; text-align: center;">
                        ...
                        <div style="font-size: 28px; font-weight: 800;">₦${(stats?.wallet_balance || 0).toLocaleString()}</div>
                        ...
                        Swal.fire({
                            ...
                            html: `
                                <div style="text-align: center;">
                                    ...
                                    <div style="font-size: 28px; font-weight: 800; color: #ff5e00;">₦${result.value.amount.toLocaleString()}</div>
                                </div>
    ...
    const getKycStatusBadge = () => {
        switch (driverData?.kyc_status) {
            ...
            default:
                return <span className="kyc-badge missing">⚠️ KYC Required</span>;
        }
    };
