...
const ClientBookRideMobile: React.FC = () => {
    ...
    // Database-backed search (like desktop) — NOT Google Places API
    ...
    const initMap = useCallback(() => {
        ...
        try {
            ...
            // Add click listener (uses actionsRef to always get latest mode/handler)
            mapInstanceRef.current.addListener('click', (e: google.maps.MapMouseEvent) => {
                if (e.latLng && actionsRef.current.handleMapClick) {
            ...
            // Search is handled by the database-backed dropdown above
